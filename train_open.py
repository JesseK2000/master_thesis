...
def parse_args():
    ...
    parser.add_argument('--eval_epoch', type=int,
                            default=10, help='interval between evaluations') # Change evaluation epoch
...
def train():
    ...
    if args.dataset == 'voc':
        data_dir = "/home/jesse/thesis/second_YOLOv1_PyTorch/data/VOCdevkit/VOC2007OPENPART1.1"
        num_classes = 17
    ...
    if args.version == 'yolo':
        ...
        yolo_net = myYOLO(device, input_size=train_size, num_classes=num_classes, trainable=True, mode='hyp') # Change mode both in yolo.py and here
