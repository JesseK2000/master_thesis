...
# VOC_CLASSES = (  # always index 0
#     'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'chair', 'cow', 
...
VOC_ROOT = path_to_dir + "/VOCdevkit/VOC2007OPENPART2.2" # change for open set eval: VOC2007OPENPART2.2
...
class VOCDetection(data.Dataset):
    ...
    def __init__(self, root, img_size,
        ...
        for (year, name) in image_sets:
            ...
            rootpath = osp.join(self.root) # Version for open set
